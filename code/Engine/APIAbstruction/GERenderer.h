...
* Base Renderer class. This provides an abstraction to which renderer to use
*/
namespace GE
{
	/*
	* An abstract class which gives the functionality for rendering stuff on to the screen.
